...
clock = pygame.time.Clock() #Used to manage the FRAME RATE, how fast the screen updates
...
while not done:
    ...
    pygame.draw.line(screen, BLACK, [300,200], [330,eyebrowX], 10) #parameters: surface. color, startXY, endXY, width
    pygame.draw.line(screen, BLACK, [370,eyebrowX], [400,200], 10) #parameters: surface. color, startXY, endXY, width
