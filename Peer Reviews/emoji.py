...
while not done:
    ...
    # MOUTH
    pygame.draw.arc(
        screen, BLACK, [310, 225, 80, blink_y + 40], (7 * PI) / 6, (11 * PI) / 6, 3
    )
    ...
    pygame.draw.ellipse(
        screen, BROWN, [290, 205, 40, blink_y]
    )  # Parameters: Surface, color {upperLeftX, upperleftY, width, height}, thickness
